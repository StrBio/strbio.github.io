...
-   **Save your session when you accomplish a wanted display:**
    ...
    -   The commands `get_view` and `set_view` are very useful to reproduce a particular view of a protein, particularly when making a movie. See <https://pymolwiki.org/Set_view>    
:::
...
## Biological units
If your protein is a multimer, you can download a biological assembly or biological unit, use the assembly setting or use type=pdb1 (monomer), type=pdb2 (dimer) and so on.
Once you have learned to create and remove objects, try to  `fetch 6KI3, type=pdb1` to display only a monomer of `6KI3`
