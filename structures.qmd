...
### 1.  Without using structural biology-specific packages, write a function that parses the files and prepares a table or report with key information from the structure, including protein name, source organism, determination method, authors, release date, resolution, and the number of peptide chains and other molecules.
