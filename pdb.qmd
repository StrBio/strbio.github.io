---
title: "Protein Structures Analysis"
date: "August 21, 2023"
...
You can write [Pymol scripts](https://pymolwiki.org/index.php/Pml) just by listing commands in a file, one command per line, appearing as they would be entered at the PyMOL command prompt. The standard extension for a PyMOL script is .pml.

Moreover, you can write more complex Python-based scripts, as detailed in the [wiki](https://pymolwiki.org/index.php/Simple_Scripting)
...
As PDB files are text files, you can easily write your own scripts to parse structures and process their data. Moreover, Python and R offer several robust libraries for parsing and visualizing protein
...
- *py3DMol:* [https://colab.research.google.com/github/CCBatIIT/modelingworkshop/blob/main/labs/1-1/py3DMol.ipynb](https://colab.research.google.com/github/CCBatIIT/modelingworkshop/blob/main/labs/1-1/py3DMol.ipynb)
- *py3DMol and MDAnalysis:* [https://colab.research.google.com/github/pb3lab/ibm3202/blob/master/tutorials/lab02_molviz.ipynb](https://colab.research.google.com/github/pb3lab/ibm3202/blob/master/tutorials/lab02_molviz.ipynb)
- *py3DMol and NGLView:* [https://colab.research.google.com/github/pb3lab/ibm3202/blob/master/tutorials/lab02_molviz.ipynb](https://colab.research.google.com/github/pb3lab/ibm3202/blob/master/tutorials/lab02_molviz.ipynb)

:::
In R, there are also packages designed for working with protein structures. The
[**bio3d**](http://thegrantlab.org/bio3d/) package is fundamental in R for bioinformatics, providing functions
...
# [**PyMOL tutorial**](pymol.html){style="color:green"}
