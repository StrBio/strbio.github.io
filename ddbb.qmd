...
Computing the RMSD for large proteins or performing pairwise calculations on
extensive datasets is often computationally prohibitive. To address this
efficiency bottleneck, we turn to Artificial Intelligence (AI). AI significantly
accelerates protein comparison, mirroring its transformative impact on the
broader field of structural bioinformatics
...
[Foldseek](https://search.foldseek.com/) [@kempen], a AI-based method designed
to identify structural similarities (see section [Protein Modeling in the
AlphaFold era](ai.html#sec-AF2)).
...
# [**In class exercise: Protein Database**]{style="color:green"}
